...
Settings contains installation-wide choices such as Console access, public directory participation, Player Portal behavior, performance and memory options, Discord integration, and other server configuration.
