...
Depending on enabled features, a player can see character and Sietch information, server-scoped market/buyback status, and other private portal views supported by the current release.
